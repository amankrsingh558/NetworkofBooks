...
<body>
	...
	<div class="content">
	<iframe src="" name="chat" style="width:350px;height:600px;display:inline;border:none;float:right" marginwidth="0" marginheight="0" frameborder="1"></iframe>
	<iframe src="messagelist.php" name="m" style="width:350px;height:600px;display:inline;border:none;float:right" marginwidth="0" marginheight="0" frameborder="1"></iframe>
	<iframe id="get" src="gener.html" style="width:220px;height:490px;display:inline;border:none" marginwidth="0" marginheight="0" frameborder="1" onmouseenter="gen()"></iframe>
	</div>
	<script>
